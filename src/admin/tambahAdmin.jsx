      ...
      <div className="admin">
          <h1>TAMBAH ADMIN</h1>
            <div className="form-admin">
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label id-admin">Id Admin</label>
                    <input type="id" class="form-control id-admin" id="exampleFormControlInput1" placeholder="Masukkan Id Baru"></input>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label nama-admin">Nama</label>
                    <input type="id" class="form-control nama-admin" id="exampleFormControlInput1" placeholder="Masukkan Nama"></input>
                </div>
                <div className="mb-3">
                    <label htmlFor="ktpInput" className="form-label foto-admin">Foto</label>
                    <input type="file" className="form-control foto-admin" id="ktpInput" onChange={handleFileUpload}></input>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label username-admin">Username</label>
                    <input type="email" class="form-control username-admin" id="exampleFormControlInput1" placeholder="Masukkan Username"></input>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label password-admin">Password</label>
                    <input type="password" class="form-control password-admin" id="exampleFormControlInput1" placeholder="Masukkan Password"></input>
                </div>
            </div>
            <button className="btn-simpan-admin" type="submit"><Link to="/informasiAdmin">SIMPAN</Link></button>
      </div>
