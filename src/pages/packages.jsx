    ...
    <>
      ...
      <div className="paket">
        ...
        <p>
          ...
          Mulai dari liburan keluarga hingga petualangan solo, kami memiliki
          beragam pilihan untuk memenuhi keinginan liburan Anda. Rasakan
          pengalaman yang tak terlupakan dan buat kenangan indah bersama kami.
        </p>
      </div>
            ...
            <div class="row align-items-center">
              ...
              >
                ...
                <button
                  className="btn-bopa"
                  type="submit"
                  style={{ marginTop: '60px', marginRight: '0px' }}
                >
