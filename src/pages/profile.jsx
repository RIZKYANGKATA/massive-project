...
import { FaWhatsapp, FaEnvelope, FaMapMarkerAlt, FaCheckCircle, FaUserCircle } from 'react-icons/fa';
    ...
    <>
      ...
      <div className="profile">
        ...
        <div className="card profil">
          <h5 style={{paddingTop: '20px', paddingLeft: '20px', fontWeight: '700'}}>Personal Detail</h5>
          <div className="container detail-profil">
            <div className="row">
              <div className="col">
                <FaUserCircle size="180px" style={{ marginRight: "10px", marginLeft: '150px' }} />
              </div>
              <div className="col">
                <div className="mb-3">
                  <label htmlFor="exampleFormControlInput1" className="nama-profil">Nama</label>
                  <input type="text" className="form-control nama-profil" id="exampleFormControlInput1" placeholder="Uhuy"></input>
                </div>
                <div className="mb-3">
                  <label htmlFor="exampleFormControlInput1" className="ttl-profil">Tempat Tanggal Lahir</label>
                  <input type="text" className="form-control ttl-profil" id="exampleFormControlInput1" placeholder="Jakarta, 25 Mei 1945"></input>
                </div>
              </div>
            </div>
          </div>
          <div className="container detail-profil-2">
            <div className="row">
              <div className="col">
                <div className="mb-3">
                  <label htmlFor="exampleFormControlInput1" className="email-profil">Email</label>
                  <input type="email" className="form-control email-profil" id="exampleFormControlInput1" placeholder="Uhuy"></input>
                </div>
              </div>
              <div className="col">
                <div className="mb-3">
                  <label htmlFor="exampleFormControlInput1" className="kota-profil">Kota</label>
                  <input type="text" className="form-control kota-profil" id="exampleFormControlInput1" placeholder="Uhuy"></input>
                </div>
              </div>
            </div>
          </div>
          <div className="container detail-profil-3">
            <div className="row">
              <div className="col">
                <div className="mb-3">
                  <label htmlFor="exampleFormControlInput1" className="no-profil">No. Telp</label>
                  <input type="text" className="form-control no-profil" id="exampleFormControlInput1" placeholder="Uhuy"></input>
                </div>
              </div>
              <div className="col">
                <div className="mb-3">
                  <label htmlFor="exampleFormControlInput1" className="provinsi-profil">Provinsi</label>
                  <input type="text" className="form-control provinsi-profil" id="exampleFormControlInput1" placeholder="Uhuy"></input>
                </div>
              </div>
            </div>
          </div>
          <div className="mb-3">
            <label htmlFor="exampleFormControlInput1" className="alamat-profil">Alamat</label>
            <input type="text" className="form-control alamat-profil" id="exampleFormControlInput1" placeholder="Uhuy"></input>
          </div>
          <h5 style={{paddingTop: '20px', paddingLeft: '20px', fontWeight: '700'}}>Submitted Documents</h5>
          <div className="mb-3">
            <label htmlFor="ktpInput" className="ktp-profil">KTP / KK</label>
