    ...
    <>
      ...
      <div className="t-decu">
        <p>
          ...
          sehari-hari. Arsitektur bangunan dan pengolahan lahan masih mengikuti
          konsep Tri Hita Karana, filosofi masyarakat Bali mengenai keseimbangan
          hubungan antara Tuhan, manusia, dan lingkungannya. Mereka berhasil
          membangun pariwisata yang menguntungkan seluruh masyarakatnya tanpa
          menghilangkan budaya dan tradisi mereka. Pada tahun 1995, desa
          Penglipuran juga mendapatkan penghargaan Kalpataru dari pemerintah
          Indonesia atas usahanya melindungi hutan bambu di ekosistem lokal
          mereka.
        </p>
        <p>
          Desa Penglipuran dipercaya mulai berpenghuni pada zaman pemerintahan I
          Dewa Gede Putu Tangkeban III.Hampir seluruh warga desa ini percaya
          bahwa mereka berasal dari Desa Bayung Gede. Dahulu orang Bayung Gede
          adalah orang-orang yang ahli dalam kegiatan agama, adat dan
          pertahanan. Karena kemampuannya, orang-orang Bayung Gede sering
          dipanggil ke Kerajaan Bangli. Namun, karena jaraknya yang cukup jauh,
          Kerajaan Bangli akhirnya memberikan daerah sementara kepada orang
          Bayung Gede untuk beristirahat. Tempat beristirahat ini sering disebut
          sebagai Kubu Bayung. Tempat inilah kemudian yang dipercaya sebagai
          desa yang mereka tempati sekarang. Mereka juga percaya bahwa inilah
          alasan yang menjelaskan kesamaan peraturan tradisional serta struktur
