    ...
    <>
      ...
      <div className="end-2">
        <div className="container text-center">
          <div className="row align-items-start">
            <div className="col">
              <div className="card text-center" style={{ maxWidth: '250px', margin: 'auto' }}>
                <div className="card-body">
                  <FontAwesomeIcon icon={faStar} size="lg" />
                  <p className="card-text">Complete Packages For All Your Wishes</p>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card text-center" style={{ maxWidth: '250px', margin: 'auto' }}>
                <div className="card-body">
                  ...
                  <p className="card-text">Expert Guides For Your Ultimate Journey</p>
                </div>
              </div>
            </div>
            <div className="col">
              <div className="card text-center" style={{ maxWidth: '250px', margin: 'auto' }}>
                <div className="card-body">
                  ...
                  <p className="card-text">Unbeatable Prices, Unforgettable Experiences!</p>
                </div>
              </div>
            </div>
          </div>
