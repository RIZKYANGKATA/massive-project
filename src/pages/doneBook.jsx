          ...
          <div className="card-body">
            <div className="container text-start pembayaran2">
              ...
              <div style={{ 
                  ...
                  <h4 style={{fontWeight: '700', textAlign: 'center', paddingTop: '40px'}}>Your Order is complete!</h4>
                <button className="btn-cekTiket"><Link to={`/cekTiket?Id=${destinationId}`}>Cek Tiket</Link></button>
              </div>
            </div>
          </div>
        </div>
