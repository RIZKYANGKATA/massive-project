    ...
    <>
      <div id="home">
        ...
        <div
          className="content"
          style={{
            backgroundImage: `url(${backgroundImageMap[destinationId]})`,
      ...
      <div class="container text-center">
        <div class="row align-items-center">
          ...
          <div class="col last-i">
            ...
            <p>
              Air terjun Cunca Wulang terletak di Kampung Wersawe, Desa Cunca
              Wulang, Kecamatan Mbeliling, Kabupaten Manggarai Barat, NTT.
              Sebelum populer seperti sekarang ini, Cunca Wulang sama sekali tak
              diketahui publik. Bahkan, masyarakat setempat pun tidak sembarang
              ke tempat itu. Baca juga: Banyak Trip Murah ke Labuan Bajo di
              Medsos, Awas Penipuan Sebab, menurut cerita dari nenek moyang,
              Cunca Wulang adalah tempat angker. Cerita itu diwariskan secara
              turun temurun dan diakui oleh masyarakat adat.
            </p>
          </div>
        </div>
      </div>
      <button className="btn-dede">
        <Link to={`/payment?Id=${destinationId}`}>BOOK NOW</Link>
      </button>
